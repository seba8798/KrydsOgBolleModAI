    ...
    */
    ...
    class Program
    {
        ...
        */
        ...
        //istedet for int skal det være object med en float val
        static Dictionary<string, List<int>> MovesAtBoardState = new Dictionary<string, List<int>>();
